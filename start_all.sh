...
start_service \
	"frontend" \
	"$FRONTEND_DIR" \
	"PORT=5000 META_AGENT_URL=http://127.0.0.1:5001 NEXT_PUBLIC_META_AGENT_URL=http://127.0.0.1:5001 WORKER_URL=http://127.0.0.1:5002 pnpm dev --port 5000"

start_service \
	"agents" \
	"$AGENTS_DIR" \
	"\"$AGENTS_PYTHON\" -m uvicorn main:app --reload --host 0.0.0.0 --port 5001"
